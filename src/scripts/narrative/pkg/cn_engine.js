...
export class WasmEngine {
    ...
    static fromSnapshot(snapshot) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmengine_fromSnapshot(ptr0, len0);
    ...
    prepare(action) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_prepare(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    resolve(candidates) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmengine_resolve(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     */
    savoirJoueur() {
        const ret = wasm.wasmengine_savoirJoueur(this.__wbg_ptr);
    ...
    trace() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmengine_trace(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cn_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
